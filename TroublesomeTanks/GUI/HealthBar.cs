...
namespace TroublesomeTanks.GUI
{
    public class HealthBar
    {
        ...
        private Rectangle[] mRectangles = new Rectangle[DGS.MAX_TANK_HEALTH];
        private Tank mTank;
        ...
        {
            int paddingWidth = 5;
            int width = (mBoundsRectangle.Width - paddingWidth * (DGS.MAX_TANK_HEALTH + 1)) / DGS.MAX_TANK_HEALTH;
            ...
            for (int i = 0; i < DGS.MAX_TANK_HEALTH; i++)
            {
